...
<script type="text/javascript">
        ...
        function displayStory(){
            ...
            var url = '{{ URL::to("getStoryByUser", "user") }}';
        ...
        function likePost(post_id){
         ...
         function removePost(userid){
               ...
               if(confirm('Are you sure you want to remove this Post') == true){
                ...
                var url = '{{ URL::to("deletePost", "user") }}';
        ...
        function getUserPost(post_id){
                ...
                var url = '{{ URL::to("getUserPost", "post_id") }}';
                    ...
                    data +=
                                    '<form class="form-horizontal">'+
                                        ...
                                        '<div class="form-group"><center>'+
                                            '<table >'+
                                                '<tr>'+
                                                    '<td style="padding:5px;">Author :</td><td>&nbsp;'+value.fullname+'</td>'+
                                                '</tr>'+
                                                '<tr>'+
                                                    '<td style="padding:5px;">Birthdate :</td><td>&nbsp;'+value.birthdate+'</td>'+
                                                '</tr>'+
                                                '<tr>'+
                                                    '<td style="padding:5px;">Emailaddress :</td><td>&nbsp;'+value.email+'</td>'+
                                                '</tr>'+
                                                '<tr>'+
                                                    '<td style="padding:5px;">Visitor :</td><td>&nbsp;'+visitor+'</td>'+
                                                '</tr>'+
                                                '<tr>'+
                                                    '<td></td><td><a href="{{ action("PagesController@editProfileDetails") }}"><p>Update Your Profile</p> </a></td>'+
                                                '</tr>'+
                                            '</table>'+
                                        '</center></div>'+
                                    '</form>';
